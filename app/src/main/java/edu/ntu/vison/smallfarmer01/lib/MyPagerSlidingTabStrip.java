package edu.ntu.vison.smallfarmer01.lib;
...
public class MyPagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private void drawTextIndicator() {
        // make sure it's a text tab
        if (!(pager.getAdapter() instanceof IconTabProvider)) {
            ...
            TextView tab = (TextView) tabsContainer.getChildAt(pager.getCurrentItem());
